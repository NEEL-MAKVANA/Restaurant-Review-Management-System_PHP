...
<head>
  ...
  <title>S'Kitchen - Review Info.</title>
...
if ($_POST['submit']) {
    $query="INSERT INTO SKITCHEN VALUE ('$srno','$name','$date','$point','$description')";
$data=mysqli_query($conn,$query);
if ($data) {
    echo "<script>alert('Record Updated')</script>";
    ?>
    <META HTTP-EQUIV="Refresh" CONTENT="0; URL=http://localhost/my%20project/Restaurant%20final/skitchen.php">
    <?php
}
else {
