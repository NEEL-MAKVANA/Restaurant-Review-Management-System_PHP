...
<head>
  ...
  <title>RAJWADU - Food and Drink</title>
    ...
    <div class="container tm-position-relative">
      ...
      <div class="row tm-welcome-content">
        <h2 class="white-text tm-handwriting-font tm-welcome-header"><img src="img/header-line.png" alt="Line"
            class="tm-header-line">&nbsp;RAJWADU's Review&nbsp;&nbsp;<img src="img/header-line.png" alt="Line"
            class="tm-header-line"></h2>
        
        <a href="#main" class="tm-more-button tm-more-button-welcome">Get Review</a>
        <a href="rajwadu_add.php" class="tm-more-button tm-more-button-welcome">Add Review</a>
      </div>
